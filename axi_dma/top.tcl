...
proc create_root_design { parentCell } {
  ...
  set sqrt [ create_bd_cell -type ip -vlnv xilinx.com:ip:floating_point:7.1 sqrt ]
  set_property -dict [list \
    CONFIG.C_Latency {29} \
    CONFIG.C_Mult_Usage {No_Usage} \
    CONFIG.C_Rate {1} \
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins fix_to_float/S_AXIS_A]
  ...
  connect_bd_intf_net -intf_net fix_to_float_M_AXIS_RESULT [get_bd_intf_pins fix_to_float/M_AXIS_RESULT] [get_bd_intf_pins sqrt/S_AXIS_A]
  ...
  connect_bd_intf_net -intf_net sqrt_M_AXIS_RESULT [get_bd_intf_pins sqrt/M_AXIS_RESULT] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  ...
  [get_bd_pins fix_to_float/aclk] \
  [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] \
  [get_bd_pins sqrt/aclk]
