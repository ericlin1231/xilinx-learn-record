...
proc create_root_design { parentCell } {
  ...
  # Create instance: find_0, and set properties
  set find_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:find:1.0 find_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins find_0/in_vec_hw]
  ...
  connect_bd_intf_net -intf_net axi_smc_M02_AXI [get_bd_intf_pins find_0/s_axi_control] [get_bd_intf_pins axi_smc/M02_AXI]
  ...
  connect_bd_intf_net -intf_net find_0_out_vec_hw [get_bd_intf_pins find_0/out_vec_hw] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  ...
  assign_bd_address -offset 0x00020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_riscv_0/Data] [get_bd_addr_segs find_0/s_axi_control/Reg] -force
  ...
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs find_0/s_axi_control/Reg]
  ...
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs find_0/s_axi_control/Reg]
