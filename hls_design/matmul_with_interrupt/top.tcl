...
proc create_root_design { parentCell } {
  ...
  set_property CONFIG.NUM_PORTS {1} $microblaze_riscv_0_xlconcat
  ...
  # Create instance: matmul_hw_0, and set properties
  set matmul_hw_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:matmul_hw:1.0 matmul_hw_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins matmul_hw_0/in_mat]
  ...
  connect_bd_intf_net -intf_net matmul_hw_0_out_mat [get_bd_intf_pins matmul_hw_0/out_mat] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net microblaze_riscv_0_axi_periph_M02_AXI [get_bd_intf_pins microblaze_riscv_0_axi_periph/M02_AXI] [get_bd_intf_pins axi_dma_0/S_AXI_LITE]
  connect_bd_intf_net -intf_net microblaze_riscv_0_axi_periph_M03_AXI [get_bd_intf_pins microblaze_riscv_0_axi_periph/M03_AXI] [get_bd_intf_pins matmul_hw_0/s_axi_control]
  ...
  connect_bd_net -net matmul_hw_0_interrupt  [get_bd_pins matmul_hw_0/interrupt] \
  ...
  [get_bd_pins matmul_hw_0/ap_clk] \
  ...
  [get_bd_pins matmul_hw_0/ap_rst_n] \
  ...
  assign_bd_address -offset 0x44000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_riscv_0/Data] [get_bd_addr_segs matmul_hw_0/s_axi_control/Reg] -force
  ...
  exclude_bd_addr_seg -offset 0x04060000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs axi_uartlite_0/S_AXI/Reg]
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs matmul_hw_0/s_axi_control/Reg]
  ...
  exclude_bd_addr_seg -offset 0x04060000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs axi_uartlite_0/S_AXI/Reg]
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs matmul_hw_0/s_axi_control/Reg]
